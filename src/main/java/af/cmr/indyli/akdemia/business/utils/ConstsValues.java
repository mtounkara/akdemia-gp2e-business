...
public class ConstsValues {
	...
	public static final class ConstsDAO {
		...
		public static final String TRAINING_DAO_KEY = "trainerDAO";
		public static final String TRAINER_DAO_KEY = "trainerDAO";
		
		/**
		 * @author Magamba
		 * --- The key for EmployeeSubscription DAO, IntraSession DAO
		 */
	...
	public static final class ServiceKeys {
		...
		/**
		 * @author Magamba
		 * --- EmployeeSubscriptionService Key, intrasession Key
		 */
		public static final String EMPLOYEE_SUBSCRIPTION_SERVICE_KEY = "EmployeeSubService";
